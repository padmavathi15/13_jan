...
const QuarterlyReport = () => {
  ...
  const maxMarks = 50; // Updated max marks
  ...
  const handleShowReport = () => {
    ...
    showSwal(
      'Generate Report?',
      'Do you want to generate the quarterly report?',
      'question',
      () => {
        setError('');
        setValidated(false);
  ...
  const handleSendReport = () => {
    showSwal(
      'Are you sure?',
      'Do you want to send the quarterly report?',
      'question',
      () => {
        Swal.fire('Sent!', 'Quarterly Report sent successfully!', 'success');
      }
    );
  };
  ...
  return (
    <div style={{ backgroundColor: '#f5f7ff', padding: '30px', height: '100%', borderRadius: '15px' }}>
      <h4 className="text-center mb-4">Quarterly Report</h4>
      ...
      <Modal show={showAddMarksModal} onHide={() => setShowAddMarksModal(false)}>
        ...
        <Modal.Footer>
          <Button variant="secondary" className="rounded-pill canceldel" onClick={() => setShowAddMarksModal(false)}>
            Close
          </Button>
          <Button variant="primary" className="rounded-pill savemodals" onClick={handleAddMarks}>
            Save Changes
          </Button>
        </Modal.Footer>
      </Modal>
